...
const legendData1 = ['大白', '长大', '杜洛克', '约克猪']
const legendData2 = ['二元', '三元', '大长', 'PIC']
const colorList = ['#0066FF', '#2E2EE6', '#4400CC', '#00AACC', '#9BBF30', '#E60000', '#92368D', '#BF9926']
